# WEB - 3.2 - Advanced State Management Sprint Challenge
...
### Welcome to Sprint Challenge!!!! :awesome_dance:

##  Flex Students:

- YOU MUST DELETE YOUR EXISTING FORK FROM GITHUB, re-fork and re-clone

##  Regarding Tech Assistance:

- Only blockers, showstoppers, README clarifications. We won’t debug code!
- Raise your :hand: in the thread. ONLY UNTIL ONE, afterwards you’ll be flying solo :airplane:

##  Regarding Codegrade:

- Wire Codegrade as soon as you get started, and push commits regularly
- You can run your own tests locally but you’ll have to visit Codegrade to see the “mvp” tests

##  Regarding the Project:

- Don’t stay broken too long. Commit every time you arrive at a “non-broken” state.
- You can “cut” all changes to all files since your last commit doing ```git stash```
- The changes can be “pasted” back by doing ```git stash pop```
- Debug, debug, debug! Console log everything, or step through the code with the debugger.
